...
subidx = str(sys.argv[8])

i = int(subidx) # run the ith subject
...
basedir = '/home/despo/whiter/gitrepos/podNtools/funccon_code/'
params_filename = basedir + 'funccon_params_' + project + '.csv' # Put name of this file into config file
